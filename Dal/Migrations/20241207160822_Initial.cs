        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommitHistories_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociatedTaskId = table.Column<long>(type: "bigint", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAssociations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskAssociations_Tasks_AssociatedTaskId",
                        column: x => x.AssociatedTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssociations_Tasks_ParentTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCollaborators_Users_CollaboratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssociations_AssociatedTaskId",
                table: "TaskAssociations",
                column: "AssociatedTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAssociations_ParentTaskId",
                table: "TaskAssociations",
                column: "ParentTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskCollaborators_CollaboratorId",
