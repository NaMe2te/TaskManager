...
namespace Dal.Migrations
{
    ...
    [Migration("20241218125102_CommitHistoryToTask")]
    partial class CommitHistoryToTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dal.Entities.Task", b =>
                {
                    ...
                    b.Property<long>("CommitHistoryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dal.Entities.Task", b =>
                {
                    ...
                    b.HasOne("Dal.Entities.CommitHistory", "CommitHistory")
                        .WithOne()
                        .HasForeignKey("Dal.Entities.Task", "CommitHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
